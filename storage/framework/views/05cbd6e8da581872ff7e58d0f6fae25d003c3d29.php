...
<div class="container p-5 align-items-center" id="print">
    ...
    <div class="p-1">
        Mã phiếu nhập : <?php echo e($order->id); ?>
    ...
    <div class="p-1">
        Tổng tiền : <?php echo e(number_format( $order->total,0 )); ?>

    </div>
    <div class="p-1">
        Nhân Viên : <?php echo e($order->user_linked->name); ?>
    ...
    <h3>Tổng tiền : <?php echo e(number_format($order->total,0)); ?> vnđ</h3>
</div>
...
<?php /**PATH C:\Users\admin\Desktop\CodeNam4\OrderFood\resources\views/admin/import/print.blade.php ENDPATH**/ ?>