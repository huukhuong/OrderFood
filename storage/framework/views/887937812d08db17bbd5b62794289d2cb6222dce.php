                ...
                <?php $__currentLoopData = $products_newest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item card-product">
                        ...
                        <div class="title">
                            ...
                            <p><?php echo e($key->price); ?> vnđ</p>
                            <h3>Còn lại <?php echo e($key->quantity); ?></h3>
                        </div>
                    </div>
        ...
        <div class="list-products">
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card-product">
                    ...
                    <p class="price">Còn lại: <?php echo e(number_format($key->quantity, 0)); ?></p>
...
<?php echo $__env->make('client.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\CodeNam4\OrderFood\resources\views/client/home.blade.php ENDPATH**/ ?>