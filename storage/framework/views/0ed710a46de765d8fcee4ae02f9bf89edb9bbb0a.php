            ...
            <form action="admin/importdetails/edit" method="post" id="myform" >
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="idImport" value="<?php echo e($importDetails->import_id); ?>" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="productID" disabled>
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option  <?php if($importDetails->product_id == $key->id): ?> selected <?php endif; ?> value="<?php echo e($key->id); ?>"> <?php echo e($key->name); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <input type="hidden" value="<?php echo e($importDetails -> product_id); ?>" name="productID">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Số lượng</label>
                        <input type="number" class="form-control" name="amount" id="amount" value="<?php echo e($importDetails->amount); ?>" required >
                        <p style="color: red" id="amount2" ></p>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Giá</label>
                        <input type="number" name="productPrice" id="productPrice" class="form-control"  value="<?php echo e($importDetails->products_linked->price_import); ?>" readonly >
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\admin\Desktop\CodeNam4\OrderFood\resources\views/admin/importdetails/edit.blade.php ENDPATH**/ ?>