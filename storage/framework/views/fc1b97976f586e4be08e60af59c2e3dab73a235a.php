...
$sumcart = 0;
                        ?>
                        <?php $__currentLoopData = $productsincart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key != null): ?>
                                <?php
                                    $sumcart++;
                                ?>
